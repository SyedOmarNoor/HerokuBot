...
module.exports.run = async (bots, message, args) => {
    ...
    .addField("#1:", "Do not expose other people to inappropriate or undesired material (inappropriate pictures or videos, loud audio) or behaviours (spamming, Suicide encouragement or threats, racism, excessive use of swear and/or curse words).")
